...
{
    /// <summary>
    /// Interaction logic for OtherMapsToMBTiles.xaml
    /// </summary>
    public partial class OtherMapsToMBTiles : Window
    {
        public OtherMapsToMBTiles()
        {
            InitializeComponent();
            InitializeComponent();
            VMConverOtherMapToMBTiles vm = new VMConverOtherMapToMBTiles();
            this.DataContext = vm;
