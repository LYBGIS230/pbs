...
{
    class VMConverOtherMapToMBTiles : INotifyPropertyChanged
    {
        ...
        private DataSourceOtherMap _datasource;
        public DataSourceOtherMap Datasource
        {
        ...
        public VMConverOtherMapToMBTiles()
        {
            IsIdle = true;
            CMDClickBrowseButton = new DelegateCommand(BrowseButtonClicked);
            CMDClickStartButton = new DelegateCommand(StartButtonClicked, (p) => { return !string.IsNullOrEmpty(Output); });
        }
        ...
        private void StartButtonClicked(object parameters)
        {
            ...
            try
            {
                ...
                Datasource = new DataSourceOtherMap("", true) { OutputFileName = Output, downloadExtent = g};
