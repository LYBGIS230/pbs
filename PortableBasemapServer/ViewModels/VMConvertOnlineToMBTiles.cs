...
namespace PBS.APP.ViewModels
{
    public class VMConvertOnlineToMBTiles:INotifyPropertyChanged,IDisposable
    {
        ...
        protected ConfigManager _configManager = ConfigManager.Instance;
        /// <summary>
        ...
        protected WebMercator _webMercator = new WebMercator();
        protected GraphicsLayer _graphicsLayer;
        protected PBSService _pbsService;
        protected int _port;
        #endregion

        public ICommand CMDClickBrowseButton { get; protected set; }
        public ICommand CMDClickStartButton { get; protected set; }
        public ICommand CMDSaveArea { get; protected set; }
        public ICommand CMDResetArea { get; protected set; }
        public ICommand CMDClickProfileButton { get; protected set; }
        public VMConvertOnlineToMBTiles()
        {
        }
        ...
        protected void MouseMove(object sender, System.Windows.Input.MouseEventArgs e)
        {
        ...
        protected void BrowseButtonClicked(object parameters)
        {
        ...
        protected void NotifyPropertyChanged<TValue>(Expression<Func<VMConvertOnlineToMBTiles, TValue>> propertySelector)
        {
