...
";
        ...
        public virtual string generateSymbolText(int level, int row, int col)
        {
            int tmsRow, tmsCol;
        ...
        protected virtual void ReadSqliteTilingScheme(out TilingScheme tilingScheme, SQLiteConnection sqlConn)
        {
        ...
        {
            if (type == "BaiduBase" || type == "BaiduHot" || type == "BaiduSate")
            {
                return true;
            }
        ...
        protected virtual byte[] HttpGetTileBytes(string uri)
        {            
        ...
        protected SQLiteConnection _connLocalCacheFile;
        protected ConcurrentDictionary<string, byte[]> _dictTilesToBeLocalCached = new ConcurrentDictionary<string, byte[]>();
        /// <summary>
...
FROM map JOIN images ON images.tile_id = map.tile_id";
        ...
        /// <param name="col"></param>
        /// <returns></returns>
        public virtual byte[] GetTileBytesFromLocalCache(int level, int row, int col)
        {
        ...
        protected virtual void InternalOnTileLoaded(object o, TileLoadEventArgs a)
        {
        ...
        protected ConvertStatus _convertingStatus;
        /// <summary>
        ...
        protected long _completeCount, _levelCompleteCount, _totalCount, _levelTotalCount, _errorCount, _levelErrorCount, _completeTotalBytes;
        /// <summary>
        /// constrain the tile downloading to the extent of an envelope or boundary shape of a polygon.
        /// </summary>
        protected Geometry _downloadGeometry;
        ...
        protected virtual void DoConvertToMBTiles(string outputPath, string name, string description, string attribution, int[] levels, Geometry geometry, bool doCompact)
        {
        ...
        protected virtual void SaveOneLevelTilesToMBTiles(int level, int startRowLevel, int startColLevel, int endRowLevel, int endColLevel)
        {
            TaskDirectory d = new TaskDirectory(level, startRowLevel, endRowLevel, startColLevel, endColLevel);
        ...
        protected virtual Dictionary<string, byte[]> GetTilesByExtent(int level, int startRow, int startCol, int endRow, int endCol)
        {
        ...
        protected virtual void WriteTilesToSqlite(Dictionary<string, byte[]> dict)
        {
            lock (_locker)
            {
        ...
        protected void CompactMBTiles(string fileName)
        {
            try
            {
        ...
        protected virtual void CreateMBTilesFileAndWriteMetaData(string outputPath, string name, string description, string attribution, Geometry geometry)
        {
            //check the wkid
